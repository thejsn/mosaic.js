...
var Mosaic = require('../../../dist/mosaic');

var element_1 = document.getElementById('imagemosaic-1');
var element_2 = document.getElementById('imagemosaic-2');

var mosaic_1 = new Mosaic(element_1);
var mosaic_2 = new Mosaic(element_2);

mosaic_1.setSize(400, 400, 10, 10);
mosaic_1.colorBlending = 0.5;

mosaic_1.addSourceFromURL('../images/1.jpg');
mosaic_1.addSourceFromURL('../images/2.jpg');
mosaic_1.addSourceFromURL('../images/3.jpg');
mosaic_1.addSourceFromURL('../images/4.jpg');
mosaic_1.addSourceFromURL('../images/5.jpg');
mosaic_1.addSourceFromURL('../images/6.jpg');
mosaic_1.addSourceFromURL('../images/7.jpg');
mosaic_1.addSourceFromURL('../images/8.jpg');
mosaic_1.addSourceFromURL('../images/9.jpg');

mosaic_1.addSourceFromURL('../images/10.jpg');
mosaic_1.addSourceFromURL('../images/11.jpg');
mosaic_1.addSourceFromURL('../images/12.jpg');
mosaic_1.addSourceFromURL('../images/13.jpg');
mosaic_1.addSourceFromURL('../images/14.jpg');
mosaic_1.addSourceFromURL('../images/15.jpg');
mosaic_1.addSourceFromURL('../images/16.jpg');
mosaic_1.addSourceFromURL('../images/17.jpg');
mosaic_1.addSourceFromURL('../images/18.jpg');
mosaic_1.addSourceFromURL('../images/19.jpg');

mosaic_1.setTargetFromURL('../images/1.jpg');
},{"../../../dist/mosaic":1}]},{},[2]);
